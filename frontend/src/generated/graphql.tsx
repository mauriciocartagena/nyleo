...
export type CrearEstudianteMutation = {
  __typename?: "Mutation";
  crearEstudiante: {
    __typename?: "EstudianteResponse";
    errors?:
...
export type EliminarEstudianteMutation = {
  __typename?: "Mutation";
...
export function useCrearEstudianteMutation() {
  return Urql.useMutation<
    CrearEstudianteMutation,
    CrearEstudianteMutationVariables
  >(CrearEstudianteDocument);
}
...
export function useEliminarEstudianteMutation() {
  return Urql.useMutation<
    EliminarEstudianteMutation,
    EliminarEstudianteMutationVariables
  >(EliminarEstudianteDocument);
}
